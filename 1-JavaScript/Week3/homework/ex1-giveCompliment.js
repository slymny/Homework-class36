...
function giveCompliment(name) {
  ...
  const ind = Math.floor(Math.random() * compliments.length);
  return `You are ${compliments[ind]}, ${name}!`;
}

console.log(giveCompliment('Salmon Honour'));
console.log(giveCompliment('Salmon Honour'));
console.log(giveCompliment('Salmon Honour'));

function main() {
  const myName = 'Salmon Honour';
